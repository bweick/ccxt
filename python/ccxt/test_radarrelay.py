...
class TestRadarRelayCCXT(TestCase):
    ...
    def test_analyze_orderbook_fillable(self, mock_fill):
        pending, leftover = self.exchange._analyze_orderbook('req/eth', 'sell', 0.000129, 2000)
    ...
    def test_analyze_orderbook_unfillable(self, mock_fill):
        pending, leftover = self.exchange._analyze_orderbook('req/eth', 'sell', 0.00015, 2000)
    ...
    def test_analyze_orderbook_partial_fill(self, mock_fill):
        pending, leftover = self.exchange._analyze_orderbook('req/eth', 'buy', 0.000176, 15000)
    ...
    def test_analyze_orderbook_market(self, mock_fill):
        pending, leftover = self.exchange._analyze_orderbook('req/eth', 'buy', float('inf'), 15000)
